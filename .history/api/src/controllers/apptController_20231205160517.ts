...
function handleAppointmentSummaryPdfff(
  dateStart: string,
  dateEnd: string
): void {
  console.log(
...
function handleBillingDetailedJson(dateStart: string, dateEnd: string): void {
  console.log(
    'Handling billing detailed report in JSON format with dates:',
    dateStart,
    dateEnd
  );
}
...
function handleBillingDetailedHtml(dateStart: string, dateEnd: string): void {
  console.log(
    'Handling billing detailed report in HTML format with dates:',
    dateStart,
    dateEnd
  );
}
...
function handleBillingDetailedPdf(dateStart: string, dateEnd: string): void {
  console.log(
    'Handling billing detailed report in PDF format with dates:',
    dateStart,
    dateEnd
  );
}
...
function handleBillingSummaryJson(dateStart: string, dateEnd: string): void {
  console.log(
    'Handling billing summary report in JSON format with dates:',
    dateStart,
    dateEnd
  );
}
...
function handleBillingSummaryHtml(dateStart: string, dateEnd: string): void {
  console.log(
    'Handling billing summary report in HTML format with dates:',
    dateStart,
    dateEnd
  );
}

function handleBillingSummaryPdf(dateStart: string, dateEnd: string): void {
  console.log(
    'Handling billing summary report in PDF format with dates:',
    dateStart,
    dateEnd
  );
}
