// Appt Detailed
export function handleAppointmentDetailedJson(
  dateStart: string,
  dateEnd: string
): string {
...
export function handleAppointmentDetailedHtml(
  dateStart: string,
  dateEnd: string
): string {
...
export function handleAppointmentDetailedPdf(
  dateStart: string,
  dateEnd: string
): string {
...
// Appt Summary
export function handleAppointmentSummaryJson(
  dateStart: string,
  dateEnd: string
): string {
...
export function handleAppointmentSummaryHtml(
  dateStart: string,
  dateEnd: string
): string {
...
export function handleAppointmentSummaryPdf(
  dateStart: string,
  dateEnd: string
): string {
