...
export function htmlHandler(
  ...
  if (typeof (window as any)[htmlFunction] === 'function') {
    // Call the dynamically generated function
    const html: string = (window as any)[htmlFunction](date, resultsArray);
    return <HtmlViewer html={html} />;
  } else {
    console.error(`Function ${htmlFunction} does not exist`);
...
const generateContent = (bot: BotType, reportType: ReportType) => {
  ...
  return `generate${botValue}${reportTypeValue}Html`;
};
