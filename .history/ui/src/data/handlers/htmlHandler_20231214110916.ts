import {
  BotType,
  ReportType,
  //   ApptDtldQueryResultItem,
  //   ApptSmmrQueryResultItem,
  //   BillSmmrQueryResultItem,
} from "../../types/koreTypes"
function processHtmlData(apiResponse: string[], htmlFunction: Function) {}

function generateApptDtldHTML(resultsArray: any[]) {
  const styledPage = `
...
export const generateHtmlView = {
  generateApptDtldHTML,
  generateApptSmmrHTML,
  generateBillSmmrHTML,
}
